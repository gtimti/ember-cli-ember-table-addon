export default Ember.HTMLBars.template((function() {
  var child0 = (function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph0, context, "view", [get(env, context, "view.headerTableContainer")], {});
        return fragment;
      }
    };
  }());
  var child1 = (function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(fragment,0,1,contextualElement);
        inline(env, morph0, context, "view", [get(env, context, "view.footerTableContainer")], {});
        return fragment;
      }
    };
  }());
  return {
    ...
    render: function render(context, env, contextualElement) {
      ...
      inline(env, morph1, context, "view", [get(env, context, "view.bodyTableContainer")], {});
      block(env, morph2, context, "if", [get(env, context, "controller.hasFooter")], {}, child1, null);
      inline(env, morph3, context, "view", [get(env, context, "view.scrollContainer")], {});
      inline(env, morph4, context, "view", [get(env, context, "view.columnSortableIndicator")], {});
      return fragment;
    }
  };
}()));
